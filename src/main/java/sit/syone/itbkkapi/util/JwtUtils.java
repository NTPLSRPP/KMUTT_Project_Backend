...
public class JwtUtils implements Serializable {
    ...
    public String generateRefreshToken(UserDetailsDTO userDetails) {
        ...
        claims.put("oid", userDetails.getOid());
        claims.put("exp", new Date(System.currentTimeMillis() + REFRESH_TOKEN_VALIDITY));
        return Jwts.builder().setHeaderParam("typ", "JWT").setClaims(claims).signWith(signatureAlgorithm, SECRET_KEY).compact();
    }
